...
const HomeAbout = () => {
  return (
    <section className="flex flex-col gap-4 max-w-5xl mx-auto py-12">
        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            <p className="text-xl font-sans font-medium text-foreground">
              ...
              production web apps using React, Next.js, TypeScript and Node.js.
              I have experience in full-stack architecture, database design, and
              API development.
            </p>
            <p className="text-xl font-sans font-medium text-foreground">
              I have led development teams and delivered scalable solutions for
              B2B and B2C platforms. I have a strong product mindset,
              translating business needs into user-focused technical solutions.
            </p>
          </div>
          <div className="flex flex-col gap-8">
            <AboutCard
